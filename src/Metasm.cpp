...
m_params        (1, m_context.new_param(m_int_type, "arg")),
m_function      ( m_context.new_function( GCC_JIT_FUNCTION_EXPORTED, m_int_type, "fun", m_params, 0)),
...
void Engine::compile( )
{
    ...
    m_context.compile_to_file(GCC_JIT_OUTPUT_KIND_ASSEMBLER ,"SCRIPT");
}

int Engine::execute()
{
    typedef int (*function)(int);
    function fun = (function)gcc_jit_result_get_code(m_result, "fun");
    return fun(1);
}
